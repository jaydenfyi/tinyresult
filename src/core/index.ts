...
export function from<R extends MaybeAsyncResult<any, any>>(result: R): MaybeAsyncResult<ResolveOkValue<R>, ResolveErrorValue<R>> {
    if (isPromiseLike(result)) {
        return Promise.resolve((result as PromiseLike<Result<any, any>>).then(from));
    }
...
export function tryCatch<T, F>(fn: () => PromiseLike<T>, onError: (e: unknown) => F): AsyncResult<T, F>;
export function tryCatch<T, F>(fn: () => T, onError: (e: unknown) => F): Result<T, F>;
...
export const flatMap: {
    ...
    ): (result: R) => ResultFor<[R, RF], ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;

    // data-first
    <R extends MaybeAsyncResult<any, any>, RF extends MaybeAsyncResult<any, any>>(
        result: R,
        fn: (v: ResolveOkValue<R>) => RF
    ): ResultFor<[R, RF], ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;
...
export const flatMapError: {
    ...
    ): (result: R) => ResultFor<[R, RF], ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;

    // data-first
    <R extends MaybeAsyncResult<any, any>, RF extends MaybeAsyncResult<any, any>>(
        result: R,
        fn: (e: ResolveErrorValue<R>) => RF
    ): ResultFor<[R, RF], ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;
