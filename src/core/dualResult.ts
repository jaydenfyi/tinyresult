...
export function all<R extends readonly MaybeAsyncResult<any, any>[]>(
    ...
    return Promise.all(results.map(r => isPromiseLike(r) ? r : Promise.resolve(r))).then((resolved) => {
        const values: any[] = [];
...
/**
 * Maps the `Ok` value of a `Result`. If the input is an `AsyncResult`, the output will be an `AsyncResult`.
 */
export const map: {
    // data-last
    <R extends Result<any, any>, U>(fn: (v: ResolveOkValue<R>) => U): (result: R) => Result<U, ResolveErrorValue<R>>;
    <R extends AsyncResult<any, any>, U>(fn: (v: ResolveOkValue<R>) => U): (result: R) => AsyncResult<U, ResolveErrorValue<R>>;
    // data-first
    <R extends Result<any, any>, U>(result: R, fn: (v: ResolveOkValue<R>) => U): Result<U, ResolveErrorValue<R>>;
    <R extends AsyncResult<any, any>, U>(result: R, fn: (v: ResolveOkValue<R>) => U): AsyncResult<U, ResolveErrorValue<R>>;
...
/**
 * Maps the `Ok` value of a `Result` to a new `Result`. The output will be async if the input is async OR the mapping function returns an `AsyncResult`.
 */
export const flatMap: {
    // data-last
    <R extends Result<any, any>, RF extends Result<any, any>>(fn: (v: ResolveOkValue<R>) => RF): (result: R) => Result<ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;
    <R extends Result<any, any>, RF extends AsyncResult<any, any>>(fn: (v: ResolveOkValue<R>) => RF): (result: R) => AsyncResult<ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;
    <R extends AsyncResult<any, any>, RF extends MaybeAsyncResult<any, any>>(fn: (v: ResolveOkValue<R>) => RF): (result: R) => AsyncResult<ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;

    // data-first
    <R extends Result<any, any>, RF extends Result<any, any>>(result: R, fn: (v: ResolveOkValue<R>) => RF): Result<ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;
    <R extends Result<any, any>, RF extends AsyncResult<any, any>>(result: R, fn: (v: ResolveOkValue<R>) => RF): AsyncResult<ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;
    <R extends AsyncResult<any, any>, RF extends MaybeAsyncResult<any, any>>(result: R, fn: (v: ResolveOkValue<R>) => RF): AsyncResult<ResolveOkValue<RF>, ResolveErrorValue<R> | ResolveErrorValue<RF>>;
...
/**
 * Maps the `Error` value of a `Result`. If the input is an `AsyncResult`, the output will be an `AsyncResult`.
 */
export const mapError: {
    // data-last
    <R extends Result<any, any>, F>(fn: (e: ResolveErrorValue<R>) => F): (result: R) => Result<ResolveOkValue<R>, F>;
    <R extends AsyncResult<any, any>, F>(fn: (e: ResolveErrorValue<R>) => F): (result: R) => AsyncResult<ResolveOkValue<R>, F>;

    // data-first
    <R extends Result<any, any>, F>(result: R, fn: (e: ResolveErrorValue<R>) => F): Result<ResolveOkValue<R>, F>;
    <R extends AsyncResult<any, any>, F>(result: R, fn: (e: ResolveErrorValue<R>) => F): AsyncResult<ResolveOkValue<R>, F>;
...
/**
 * Maps the `Error` value of a `Result` to a new `Result`. The output will be async if the input is async OR the mapping function returns an `AsyncResult`.
 */
export const flatMapError: {
    // data-last
    <R extends Result<any, any>, RF extends Result<any, any>>(fn: (e: ResolveErrorValue<R>) => RF): (result: R) => Result<ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;
    <R extends Result<any, any>, RF extends AsyncResult<any, any>>(fn: (e: ResolveErrorValue<R>) => RF): (result: R) => AsyncResult<ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;
    <R extends AsyncResult<any, any>, RF extends MaybeAsyncResult<any, any>>(fn: (e: ResolveErrorValue<R>) => RF): (result: R) => AsyncResult<ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;

    // data-first
    <R extends Result<any, any>, RF extends Result<any, any>>(result: R, fn: (e: ResolveErrorValue<R>) => RF): Result<ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;
    <R extends Result<any, any>, RF extends AsyncResult<any, any>>(result: R, fn: (e: ResolveErrorValue<R>) => RF): AsyncResult<ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;
    <R extends AsyncResult<any, any>, RF extends MaybeAsyncResult<any, any>>(result: R, fn: (e: ResolveErrorValue<R>) => RF): AsyncResult<ResolveOkValue<RF> | ResolveOkValue<R>, ResolveErrorValue<RF>>;
...
export const catchError: {
    // data-last
    <R extends Result<any, any>, U>(fn: (e: ResolveErrorValue<R>) => U): (result: R) => Result<ResolveOkValue<R> | U, never>;
    <R extends AsyncResult<any, any>, U>(fn: (e: ResolveErrorValue<R>) => U): (result: R) => AsyncResult<ResolveOkValue<R> | U, never>;

    // data-first
    <R extends Result<any, any>, U>(result: R, fn: (e: ResolveErrorValue<R>) => U): Result<ResolveOkValue<R> | U, never>;
    <R extends AsyncResult<any, any>, U>(result: R, fn: (e: ResolveErrorValue<R>) => U): AsyncResult<ResolveOkValue<R> | U, never>;
} = dual(2, (result: MaybeAsyncResult<any, any>, fn: (e: any) => any): any => {
    if (isPromiseLike(result)) {
...
/**
 * Performs a side-effect with the `Error` value, returning the original `Result`.
 */
...
/**
 * Performs a side-effect on a `Result`, returning the original `Result`.
 */
...
/**
 * Unwraps a `Result` by providing handlers for `Ok` and `Error` cases.
 */
export const match: {
    // data-last
    <R extends Result<any, any>, TValue, TError>(onOk: (v: ResolveOkValue<R>) => TValue, onError: (e: ResolveErrorValue<R>) => TError): (result: R) => TValue | TError;
    <R extends AsyncResult<any, any>, TValue, TError>(onOk: (v: ResolveOkValue<R>) => TValue, onError: (e: ResolveErrorValue<R>) => TError): (result: R) => PromiseLike<TValue | TError>;

    // data-first
    <R extends Result<any, any>, TValue, TError>(result: R, onOk: (v: ResolveOkValue<R>) => TValue, onError: (e: ResolveErrorValue<R>) => TError): TValue | TError;
    <R extends AsyncResult<any, any>, TValue, TError>(result: R, onOk: (v: ResolveOkValue<R>) => TValue, onError: (e: ResolveErrorValue<R>) => TError): PromiseLike<TValue | TError>;
...
const validatedUsername = all([tapBoth(mapError(
    map(
        flatMap(
...
const validatedUsername2 = pipe(
    ...
    Promise.resolve(ok("zuck" as const)),
